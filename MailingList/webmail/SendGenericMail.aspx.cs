...
{
	public partial class SendGenericMail : G
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			else
			{
				if(!Page.IsPostBack)
				{
					MailIn.Text="<img border=0 src=/i/mailin.gif>&nbsp;" + Root.rm.GetString("Mailtxt9");
				}
		...
		{
			Response.Redirect("/webmail/webmail.aspx?m=46&dgb=1&si=63");
		}
	}
}
