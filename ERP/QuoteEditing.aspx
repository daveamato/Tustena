...
<%@ Page language="c#" Codebehind="QuoteEditing.aspx.cs" AutoEventWireup="false" Inherits="Digita.Tustena.ERP.QuoteEditing" %>
		...
		<table cellpadding=0 cellspacing=0 class="normal" bgcolor="#ffffff" style="BORDER-RIGHT:#000 1px solid; BORDER-TOP:#000 1px solid;BORDER-LEFT:#000 1px solid; BORDER-BOTTOM:#000 1px solid" width="90%" align=center>
			...
			<tr>
				<td align=right colspan=3 style="padding-top:5px;padding-right:5px">
						...
						<asp:LinkButton ID="btnClone" Runat=server CssClass="Save"></asp:LinkButton>
						<asp:LinkButton ID="btnCopyToOrder" Runat=server CssClass="Save"></asp:LinkButton>
					...
					<table width="100%" cellspacing=0 cellpadding=0>
									...
									<td width="25" align=right>
									    <span id="SelectOwner" runat=server>
										    &nbsp;<img src="/i/user.gif" border="0" style="CURSOR:pointer" onclick="alert('<%=wrm.GetString("Quotxt46")%>');CreateBox('/common/PopAccount.aspx?render=no&textbox=TextboxSearchOwner&textbox2=TextboxSearchOwnerID&event=CheckManager()',event)">
										</span>
									</td>
									</tr>
					</table>
			...
			<tr>
				<td width="30%">
					<%=wrm.GetString("Quotxt4")%>
					<domval:RequiredDomValidator ID="QValidDataValidator" Display=Static ControlToValidate="QValidData" Runat="server">*</domval:RequiredDomValidator>
				</td>
				<td>
					<table width="100%" cellspacing=0 cellpadding=0>
										<tr><td>
											<asp:TextBox id="QValidData" runat="server" Width="100%" onkeypress="DataCheck(this,event)" CssClass="BoxDesignReq"></asp:TextBox>
										</td>
										<td width="25" align=right>
